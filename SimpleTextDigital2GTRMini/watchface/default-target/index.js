try {
    (() => {
        ...
        let dateFormat = '';
        let dateFormatMap = '';
        let normal$_$text_0f6c97d9b3da449ebde69432f7b41b15 = '';
        let batterySensor = '';
        let timeSensor = '';
        let heartSensor = '';
        let stepSensor = '';
        ...
        __$$module$$__.module = DeviceRuntimeCore.WatchFace({
            init_view() {
                ...
                normal$_$text_0f6c97d9b3da449ebde69432f7b41b15 = hmUI.createWidget(hmUI.widget.TEXT, {
                    x: 330,
                    y: 157,
                    w: 80,
                    h: 48,
                ...
                batterySensor.addEventListener(hmSensor.event.CHANGE, function () {
                    ...
                    normal$_$text_b1525f24049740338f2233271e1dfcd7.setProperty(hmUI.prop.MORE, { text: `${ String(timeSensor.hour).padStart(2, '0') } : ${ String(timeSensor.minute).padStart(2, '0') }` });
                ...
                normal$_$text_b1525f24049740338f2233271e1dfcd7.setProperty(hmUI.prop.MORE, { text: `${ String(timeSensor.hour).padStart(2, '0') } : ${ String(timeSensor.minute).padStart(2, '0') }` });
                normal$_$text_0f6c97d9b3da449ebde69432f7b41b15.setProperty(hmUI.prop.MORE, { text: `${ String(timeSensor.second).padStart(2, '0') }` });
                timer.createTimer(0, 1000, function (timeSensor2) {
                    normal$_$text_b1525f24049740338f2233271e1dfcd7.setProperty(hmUI.prop.MORE, { text: `${ String(timeSensor2.hour).padStart(2, '0') } : ${ String(timeSensor2.minute).padStart(2, '0') }` });
                    normal$_$text_0f6c97d9b3da449ebde69432f7b41b15.setProperty(hmUI.prop.MORE, { text: `${ String(timeSensor2.second).padStart(2, '0') }` });
                }, timeSensor);
